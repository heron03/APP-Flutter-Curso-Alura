import 'package:banco/components/editor.dart';
      ...
      appBar: AppBar(
        ...
        child: Column(
          children: <Widget>[
            ...
            Editor(controlador: _controladorCampoValor, rotulo: _rotuloCampoValor, dica: _dicaCampoValor, icon: Icons.monetization_on),
            
            RaisedButton(
              child: Text(_textoBotaoConfirmar), onPressed: () => _criaTransferencia(context),
            ),
          ],
        ),
      ),
